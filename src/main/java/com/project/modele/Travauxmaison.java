...
@TableName(database = "btp", driver = "postgres", name = "travauxmaison", password = "Maroussia1833", user = "postgres")
public class Travauxmaison extends JDBC {
...
Double quantite;
    ...
    public Travauxmaison() throws Exception{

    }

    public Travauxmaison(String idmaison ,String idtravaux ,Double quantite)throws Exception{
